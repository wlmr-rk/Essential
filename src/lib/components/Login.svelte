...
<div class="min-h-screen flex items-center justify-center bg-black relative overflow-hidden">
	...
	<div class="absolute inset-0 opacity-20">
		<div class="absolute inset-0" style="background-image: linear-gradient(rgba(0,255,159,0.1) 1px, transparent 1px), linear-gradient(90deg, rgba(0,255,159,0.1) 1px, transparent 1px); background-size: 50px 50px;"></div>
	</div>
	...
	<div class="arasaka-panel max-w-md w-full mx-4 relative z-10">
		<div class="p-8">
			...
			<div class="text-center mb-8">
				<div class="mb-4">
					<div class="w-16 h-16 mx-auto bg-gradient-to-br from-green-400 to-cyan-400 rounded-lg flex items-center justify-center mb-4">
